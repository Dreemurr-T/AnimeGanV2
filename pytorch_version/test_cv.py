...
def parse_args():
    ...
    parser.add_argument('--checkpoint_dir',type=str,default='checkpoint_v1/Hayao/Generator/epoch_109_batchsize_4.pth')
...
def test(args):
    ...
    for photo_name in tqdm(photo_names):
        ...
        save_photo = (save_photo + 1) * 127.5
        save_photo = save_photo.clip(0,255)
